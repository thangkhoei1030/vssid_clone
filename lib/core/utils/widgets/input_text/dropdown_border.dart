...
class _DropdownMenuItemContainer extends StatelessWidget {
  ...
  ///
  /// Typically a [AutoSizeText] widget.
  final Widget child;
...
class DropdownButtonCustom<T> extends StatefulWidget {
  ...
  ///
  /// This sample shows a `DropdownButtonCustom` with a button with [AutoSizeText] that
  ...
  ///           return AutoSizeText(item);
  ///         }).toList();
  ///       },
  ///       items: items.map((String item) {
  ///         return DropdownMenuItemCustom<String>(
  ///           child: AutoSizeText('Log $item'),
  ///           value: item,
  ///         );
  ///       }).toList(),
  ///     ),
...
class _DropdownButtonState<T> extends State<DropdownButtonCustom<T>>
  ...
  TextStyle? get _textStyle =>
      widget.style ?? Theme.of(context).textTheme.bodySmall;
